...
val StringsDe = Strings(
    ...
    bpErrOutputIsFolder = "Der Ziel-Pfad ist ein Ordner — bitte einen Dateinamen angeben.",
    bpErrOutputParentNotWritable = "Der Ziel-Ordner kann nicht angelegt oder beschrieben werden.",
    bpErrOutputFileReadOnly = "Die Ziel-Datei ist schreibgeschützt.",
    ...
    bpStatusAllSkipped = { count -> "Keine Log-Datei lesbar — $count Datei(en) übersprungen." },
    bpSkippedNote = { count, names -> "$count Log(s) übersprungen (nicht lesbar): $names" },
    ...
    rfStatImages = "Bilder",
    rfStatSelected = "Ausgewählt",
    rfStatOrder = "Auftrag",
    rfStatResolution = "Auflösung",
    rfStatModel = "Modell",
    rfSelectAll = "Alle auswählen",
    rfDeselectAll = "Alle abwählen",
    rfCropTagAuto = "vlm",
...
val StringsEn = Strings(
    ...
    bpErrOutputIsFolder = "The target path is a folder — please provide a file name.",
    bpErrOutputParentNotWritable = "The target folder cannot be created or written to.",
    bpErrOutputFileReadOnly = "The target file is read-only.",
    ...
    bpStatusAllSkipped = { count -> "No log file readable — $count file(s) skipped." },
    bpSkippedNote = { count, names -> "$count log(s) skipped (unreadable): $names" },
    ...
    rfStatImages = "Images",
    rfStatSelected = "Selected",
    rfStatOrder = "Order",
    rfStatResolution = "Resolution",
    rfStatModel = "Model",
    rfSelectAll = "Select all",
    rfDeselectAll = "Deselect all",
    rfCropTagAuto = "vlm",
